...
* **21 Routes with dynamic JSON incident translators (`post-function`):**
  * Configures all 21 `/va/sov-38alt-...` routes mapping each edge camera to its respective incident type and live timestamped payload.
